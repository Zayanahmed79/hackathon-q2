...
const Offer = () => {
    ...
    return (
        <div  id="services" className={`${lato.className} bg-white py-10`}>
            <h1 className={`${jsfont} text-[42px] text-center font-bold py-12 text-[#151875]`}>What Shopex Offer!</h1>
            <div className="flex flex-wrap justify-center gap-6">
                {/* 1 */}
                <div data-aos="flip-left"  className="flex hover:scale-105 duration-150 flex-col gap-3 justify-center p-3 shadow-lg w-[270px] h-[320px] text-center items-center">
